...
const Blog = () => {
    return (
        <div className='w-[90%] lg:w-[70%] mx-auto my-12'>
            <h1 className='font-bold text-4xl mb-7 lg:mb-12 text-center'>Featured Blogs</h1>
            <div className='bg-rose-200 p-5 rounded-lg mb-6'>
